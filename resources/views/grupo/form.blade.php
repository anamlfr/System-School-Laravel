...
<div class="content">
        ...
        @endif
            ...
            <form action="{{ asset('/Grupo/create/') }}" method="post">
                @csrf
                <div class="form row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="carrera">Carrera</label>
                                <select class="form-control" aria-label="Default select example" name="id_carrera" id="id_carrera">
