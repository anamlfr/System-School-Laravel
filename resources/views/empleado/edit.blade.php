             ...
             <div class="card-body shadow" >
              ...
              @if(count($errors)>0)
                 ...
                 <div class="card-body border-primary">
                        <form action="{{ url('/Empleado/update/'.$empleado->id) }}" method="post">
                            @csrf
                            <div class="form row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="nombre" value="{{ isset($empleado->nombre)?$empleado->nombre:old('nombre') }}" id="nombre"><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="ap_paterno" value="{{ isset($empleado->ap_paterno)?$empleado->ap_paterno:old('ap_paterno') }}" id="ap_paterno"><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="ap_materno" value="{{ isset($empleado->ap_materno)?$empleado->ap_materno:old('ap_materno') }}" id="ap_materno"><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="curp" value="{{ isset($empleado->curp)?$empleado->curp:old('curp') }}" id="curp"><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="rfc" value="{{ isset($empleado->rfc)?$empleado->rfc:old('rfc') }}" id="rfc"><br>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <label for="profesion">Grado Académico</label>
                                            <select name="profesion" id="profesion" class="form-control">
                                                ...
                                                <option value="Licenciatura/Ingenieria">Licenciatura/Ingeniería</option>
                                                ...
                                                <span class="iborrainputfile">Seleccionar fotografía</span>
                                                    ...
                                                    <div class=" img-fluid img-circle" style="margin-top:-30px; margin-left: 210px;">
                                                        @if(isset($empleado->url_foto))
                                                            <img src="{{ asset('fotos'.'/'.$empleado->url_foto) }}" alt="foto empleado" width="100" class="img-thumbnail img-fluid"> <br>
                                                        @endif
                                                    </div>
